...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "url": "https://bokepojol.pages.dev",
        "description": `${SITENAME} Video bokep indo jepang indonesia barat terbaru viral korea simontok china tante live sma paksa ngentot abg jilbab cewek bocil smp pijat pelajar.`,
        "image": "https://bokepojol.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://bokepojol.pages.dev/"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
...
<script type="text/javascript" src="https://js.juicyads.com/jp.php?c=947403z2v256s2x2w264x294&u=http%3A%2F%2Fwww.juicyads.rocks"></script>
        </html>
    );
}
